...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Client.clientimagemonth'
        db.add_column(u'report_client', 'clientimagemonth',
                      self.gf('django.db.models.fields.CharField')(default='mmyyyy', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Client.clientimagemonth'
        db.delete_column(u'report_client', 'clientimagemonth')
