...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DataiumSiteTraffic'
        db.create_table(u'report_dataiumsitetraffic', (
            ...
            ('percentdma', self.gf('django.db.models.fields.FloatField')(default=0.0)),
        ))
        db.send_create_signal(u'report', ['DataiumSiteTraffic'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'DataiumSiteTraffic'
        db.delete_table(u'report_dataiumsitetraffic')
    ...
    models = {
        ...
        u'report.dataiumsitetraffic': {
            'Meta': {'object_name': 'DataiumSiteTraffic'},
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'percentdma': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
