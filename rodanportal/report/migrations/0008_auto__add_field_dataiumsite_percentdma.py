...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataiumSite.percentdma'
        db.add_column(u'report_dataiumsite', 'percentdma',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataiumSite.percentdma'
        db.delete_column(u'report_dataiumsite', 'percentdma')
