...
// START OF DMM CHART - UPPER RIGHT
       ...
       // jpb, 3/16/2014, changed to use week of year format rather than yearmonth
	...
	var color = d3.scale.ordinal()
        ...
        var xAxis = d3.svg.axis().scale(x)
            .orient("bottom")
            // jpb, 3/16/2014 changed to use week of year format
...
// Adds the chart in the upper left on row 1
        ...
        d3dmmdata = d3dmmdata.map( function(d) {
            return {
                ...
                // jpb, 3/16/2014, changed to use weeks as an integer instead of yearmonth
                // date: parseDate(d.fields.yearmonth),
                date: +d.fields.yearmonth,
                // jpb, end
                dmm : +d.fields.dmm };
        });
