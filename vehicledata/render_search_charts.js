...
/* render_search_charts.js
	render the word tag clouds to individuals files to serve up in email.
	jpb, 2/17/2014
...
RenderUrlsToFile = function(urls, callbackPerUrl, callbackFinal) {
    ...
    getFilename = function() {
        return "client_search_" + urlIndex + ".png";
    };
...
if (phantom.args.length != 1) {
	...
	//	arrayOfUrls.push("https://report-ninja-c9-muttinthehut.c9.io/client_search/get/"+(i+1)+"/");
		arrayOfUrls.push("http://127.0.0.1:8000/report/client_search/get/"+(i+1)+"/");
	}
